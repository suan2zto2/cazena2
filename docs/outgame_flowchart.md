...
| 모드 | 세부 | 사용 덱 | 설명 |
|------|------|---------|------|
| **스토리 모드** | 메인 스토리 | 로그라이크 방식 | 8챕터 순차 진행. 챕터당 일반 로그라이크 1개 + 일반 전투 + 스토리 스테이지 배치 |
| **스토리 모드** | 서브 스토리 | 로그라이크 방식 | 조건부 해금. 캐릭터별 개인 스토리 및 단편 에피소드 |
| **전투 모드** | 도전 로그라이크 | 로그라이크 방식 | 챕터 클리어 후 계속 도전. 최종 패배 시 도전 팀덱 저장 |
| **전투 모드** | 일반 전투 | 일반 팀덱 | 고정 스테이지 리스트. 뒤로 갈수록 강한 적 |
| **전투 모드** | 도전 전투 | 도전 팀덱 | 고정 스테이지 리스트. 조건부 해금 |
| **캐릭터 정보** | — | — | 5인 캐릭터 능력치 · 스킬덱 열람 전용 |
| **팀 구성** | — | — | 일반·도전 팀덱 1~10팀 저장 관리 |
